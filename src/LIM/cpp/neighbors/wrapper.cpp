...
static PyObject* batch_neighbors(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	queries = std::vector<PointXYZ>((PointXYZ*)PyArray_DATA((PyArrayObject*) queries_array), (PointXYZ*)PyArray_DATA((PyArrayObject*) queries_array) + Nq);
	supports = std::vector<PointXYZ>((PointXYZ*)PyArray_DATA((PyArrayObject*) supports_array), (PointXYZ*)PyArray_DATA((PyArrayObject*) supports_array) + Ns);
	q_batches = std::vector<int>((int*)PyArray_DATA((PyArrayObject*)q_batches_array), (int*)PyArray_DATA((PyArrayObject*)q_batches_array) + Nb);
	s_batches = std::vector<int>((int*)PyArray_DATA((PyArrayObject*)s_batches_array), (int*)PyArray_DATA((PyArrayObject*)s_batches_array) + Nb);
