...
def import_without_init(
    ...
    try:
        ...
        spec: ModuleSpec = importlib.util.spec_from_file_location(path_to_file.stem, Path(path_to_file))  # pyright: ignore[reportAssignm
        ...
        #     if ignore is not None and e.name in ignore:
        #         pass
        #     else:
        #         raise
    finally:
